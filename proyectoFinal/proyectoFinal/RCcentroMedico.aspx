    ...
    <div class="col-4">
        <div class="alert alert-dark mt-3" role="alert">
            <h3 class="text-center">
                <asp:Label ID="lblMensaje" runat="server" Text="" CssClass="text-center"></asp:Label></h3>
        </div>
        <div class="card mt-5">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="custom-file">
                            ...
                            <label id="texto" class="custom-file-label" for="contenidoMenuEps_archivo">Seleccione la foto...</label>
                        </div>
                    </div>
                </div>
            </div>
