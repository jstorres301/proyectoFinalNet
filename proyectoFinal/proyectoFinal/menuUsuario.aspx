<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuUsuario.aspx.cs" Inherits="proyectoFinal.menuUsuario" %>
        ...
        <div class="nav nav-tabs flex-column w-100 border-0 d-flex justify-content-between h-75 font-italic">
            <div class="h-75 float-left">
                ...
                <li class="nav-item nav-link" data-toggle="tab" role="tab" style="cursor:pointer;">
                    <a target="mesa">
                        <h3><i class="fas fa-hospital"></i> Consultar Centros Medicos</h3>
                    </a>
                </li>
                
                <li class="nav-item nav-link" data-toggle="tab" role="tab" style="cursor:pointer;">
                    <a target="mesa">
                        <h3><i class="far fa-address-book"></i> Agendar Cita medica</h3>
                    </a>
                </li>
                
                <li class="nav-item nav-link" data-toggle="tab" role="tab" style="cursor:pointer;">
                    <a target="mesa">
                        <h3><small><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i></small> Calificar Cita Medica</h3>
                    </a>
                </li>
            </div>
