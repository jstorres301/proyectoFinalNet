<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuAdministrador.aspx.cs" Inherits="proyectoFinal.menuAdministrador" %>
...
<body class="row d-flex h-100 w-100 m-0 p-0 bg-transparent">
    <form id="form1" runat="server" class="h-100 w-100 m-0 p-0">
            ...
            <div class="nav nav-tabs flex-column w-100 border-0 d-flex justify-content-between h-75 font-italic">
                <div class="h-75 float-left">
                    <li class="nav-item nav-link mt-5" data-toggle="tab" role="tab" style="cursor: pointer;">
                        <a target="mesa" href="Reportes.aspx">
                            <h3><i class="fas fa-chart-pie"></i>Grafico en torta</h3>
                        </a>
                    </li>

                    <li class="nav-item nav-link" data-toggle="tab" role="tab" style="cursor: pointer;">
                        <a target="mesa" href="Reportes.aspx">
                            <h3><i class="fas fa-chart-bar"></i>Grafico en barras</h3>
                        </a>
                    </li>
                </div>
        ...
        <div class="h-100 m-0 p-0 border-0 d-flex justify-content-center float-left" style="width: 80%;">
            <iframe class="w-100 h-100 m-0 p-0 border-0 embed-responsive-item" name="mesa" id="mesa" allowfullscreen accesskey="mesa"></iframe>
        </div>
    </form>
